...
vector<SearchParams> Setup::loadParams(
  ...
  for(int i = 0; i<numBots; i++) {
    ...
    if(cfg.contains("useBayesSelection"+idxStr)) params.useBayesSelection = cfg.getBool("useBayesSelection"+idxStr);
    else if(cfg.contains("useBayesSelection"))   params.useBayesSelection = cfg.getBool("useBayesSelection");
    else                                         params.useBayesSelection = false;
    if(cfg.contains("useBayesChooseMu"+idxStr)) params.useBayesChooseMu = cfg.getBool("useBayesChooseMu"+idxStr);
    else if(cfg.contains("useBayesChooseMu"))   params.useBayesChooseMu = cfg.getBool("useBayesChooseMu");
    else                                        params.useBayesChooseMu = false;
    ...
    if(cfg.contains("useBayesContrastSelection"+idxStr)) params.useBayesContrastSelection = cfg.getBool("useBayesContrastSelection"+idxStr);
    else if(cfg.contains("useBayesContrastSelection"))   params.useBayesContrastSelection = cfg.getBool("useBayesContrastSelection");
    else                                                 params.useBayesContrastSelection = false;
